...
@Component
public class OperationsListDocumentGeneratorStrategy extends DocumentGeneratorStrategy {

	private static final String RPT_BASE = "rpt_base";

	private static final String STAT_REPORTERROR_MSG = "angal.stat.reporterror.msg";

	private static final Logger LOGGER = LoggerFactory.getLogger(OperationsListDocumentGeneratorStrategy.class);
	...
	public int getDocumentType() {
		return DocumentType.OPERATIONS_LIST;
	}

	@Override
	public boolean accept(int documentType) {
		return this.getDocumentType() == documentType;
	}
